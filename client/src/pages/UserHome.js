    ...
    <>
      ...
      <main className="user-home">
        <section className="left">
          <h1>
            SafePlace —<br /> ваша безопасность в ваших руках
          </h1>
        ...
        <section className="right">
          <div className="user-sections">
            <div className="section-card">
              ...
              <Link to="/forum" className="tile-btn">
                Перейти
              </Link>
            </div>
            <div className="section-card">
              ...
              <Link to="/favorites" className="tile-btn">
                Перейти
              </Link>
            </div>
            <div className="section-card">
              ...
              <Link to="/messages" className="tile-btn">
                Перейти
              </Link>
            </div>
            <div className="section-card">
              ...
              <Link to="/help" className="tile-btn">
                Перейти
              </Link>
            </div>
          </div>
